...
namespace lab5
{
    public partial class Form1 : Form
    {
        ...
        public void CreateNameWork()
        {
            Graphics g = pictureBox1.CreateGraphics();
            // Задаем координаты точек многоугольника
            Point[] point = new Point[11] { new Point(120, 20),
            new Point(180, 35), new Point(240, 25),
            new Point(300, 30), new Point(360, 20),
            new Point(420, 30), new Point(420, 80),
            new Point(360, 95), new Point(290, 75),
            new Point(220, 90), new Point(130, 80),
            };
        ...
        public void CreateDiagramm()
        {
            ...
            string[] year = new string[9] { "Максим", "Дима", "Рома", "Петя", "Богдан", "Настя", "Дарина", "Артем", " Cергей" };
            // Задаем значения элементов массива заработных плат
            int[] value = new int[9] { 90, 113, 134, 156, 166, 177, 187, 196, 205 };
            ...
            HatchBrush hb = new HatchBrush(HatchStyle.DashedHorizontal, Color.CornflowerBlue, Color.LightSkyBlue);
