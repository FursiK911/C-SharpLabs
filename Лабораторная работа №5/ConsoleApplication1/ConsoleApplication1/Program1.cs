...
namespace ConsoleApplication1
{
    partial class Program
    {
        static void Main(string[] args)
        {
            ...
            peremennaya.fio = "Петров А.А.";
            peremennaya.tip = 'Т';
            peremennaya.year = 1950;
            peremennaya.exp = 22;
            nabor[1] = peremennaya;

            peremennaya.fio = "Шишкин С.К.";
            peremennaya.tip = 'C';
            peremennaya.year = 1984;
            peremennaya.exp = 8;
            nabor[2] = peremennaya;

            peremennaya.fio = "Кравченко Г.А.";
            peremennaya.tip = 'C';
            peremennaya.year = 1981;
            peremennaya.exp = 10;
            nabor[3] = peremennaya;
            FileStream file = new FileStream(@"lab.dat", FileMode.Append, FileAccess.Write);
            StreamWriter sWriter = new StreamWriter(file);
            for (int i = 1; nabor[i].fio != null; i++)
            {
